...
from src.classifiers import create_inceptionv3
...
def main():
    ...
    ap.add_argument('-name', '--model_name', help='Model name', default='inseption')

    args = vars(ap.parse_args())

    create_inceptionv3(args['img_height'], args['img_width'], args['num_channels'], args['num_classes'], args['model_name'])
